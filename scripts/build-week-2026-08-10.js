...
function stockNote(stock) {
  const notes = {
    "600721": "本周最清楚的赚钱票。百花医药竞价买入900股，次日分三笔全部兑现，含费用可见闭环约+1,115.44。问题不是方向，而是日度复盘里提到的“卖早”：题材强度确认后可以给核心票更多持股时间。",
  ...
  return `<section class="panel" id="profit-loss">
    ...
    <div class="thesis-grid">
      <article>
        ...
        <p>创新药方向试错成功，竞价买入900股，次日全部卖出，闭环贡献最清楚。赚钱根源在于方向判断和隔日兑现都成立；待改进点是卖早，后续遇到题材强度继续确认的核心票，止盈应更贴合强度和承接。</p>
      </article>
      <article>
    ...
    <div class="rules">
      <article><span>01</span><b>赚钱根源</b><p>百花医药是“方向 + 买点 + 隔日兑现”三件事同时做对。</p></article>
      ...
      <article><span>04</span><b>下周重点</b><p>华西低吸如果不能主动表态，就按试错仓处理，不能主观升级为核心仓。</p></article>
    </div>
  </section>`;
}
...
function renderRules() {
  const rules = [
    ...
    ["卖早要复盘", "百花医药方向对了、闭环盈利也对，但卖点偏早；题材强度确认后，核心票要给一点持股空间。"],
    ["低吸先分层", "华西股份这种回流低吸，确认前只能小仓，确认后再加仓；第一次下探不能直接打满预期。"],
    ["科技先手快验", "亨通光电、风华高科这种尾盘科技先手，次日不强就走，不能把先手试错升级成主线格局。"],
    ["唯一性优先", "不是唯一核心、不是板块第一，就不要重仓；低位试错可以，格局必须给辨识度。"],
    ["历史持仓另算", "风范股份这种历史持仓卖出，必须补历史成本再核算，不把现金到账误判成盈利。"],
    ["账户口径分离", "成交净流入不是账户收益；期末持仓市值、浮盈亏、总资产必须单独补齐。"],
    ["计划内交易", "每日先写明标的定位：龙头、套利、反抽、低吸试错；定位不清就不扩大仓位。"],
  ];
...
<body>
  ...
  <main class="page-shell">
    ...
    <section class="panel thesis-panel">
      ...
      <h2>这一周先写成一个核心问题</h2>
      <p class="lead">本周核心不是交易频率，而是“定位是否清楚”：百花医药是创新药试错后的成功闭环，通鼎互联是老龙反抽买急后的亏损闭环，华西股份是回流低吸但还没被证明是唯一核心的期末待验证仓。</p>
      <div class="thesis-grid">
        <article><b>做对</b><p>百花医药隔日闭环贡献约+1,115.44，说明创新药方向和买点判断有效；亨通、风华在科技分歧日处理得比较干净。</p></article>
        <article><b>待优化</b><p>通鼎互联不是唯一核心，老龙反抽买点偏急，次日亏损约-753.74；这种票以后只能小仓、快验、快走。</p></article>
